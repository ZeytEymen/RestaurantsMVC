...
namespace QR_Menu.Controllers
{
    public class RestaurantsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Phone,PostalCode,AddressDetail,RegisterDate,CompanyId,StateId")] Restaurant restaurant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Phone,PostalCode,AddressDetail,RegisterDate,CompanyId,StateId")] Restaurant restaurant)
        {
            if (id != restaurant.Id)
            {
                return NotFound();
